...
<div class="row">
  ...
  <!-- Complete button: Only show if the ticket's workorders is not null -->
    @if((Auth::user()->can('ticket.edit') || $isAdmin) && $tickets->workorders->isNotEmpty())
                    ...
                    <form action="{{ url('ticket/'.$tickets->id) }}" method="POST" style="display: inline;">
                        ...
                        <div class="col-md-10" id="">
                            <div class="form-group">
                                ...
                                <select name="property_id" id="property_id" class="formcontrolnoedit" placeholder="Select" required readonly>
