...
@if(empty($sitesettings))
    ...
    @else
    <form method="POST" action="{{ url('settingsite/update/1') }}">
        @csrf
        @method('PUT')
            ...
            <div class=" contwrapper">
                    ...
                    <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img id="logo-image-before-upload" src="{{ url('resources/uploads/images/'.$sitesettings->company_logo) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <img id="flavicon-image-before-upload"  src="{{ url('resources/uploads/images/'.$sitesettings->company_flavicon) }}"
