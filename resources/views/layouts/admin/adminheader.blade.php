...
<head>
  ...
  <!-- inject:css -->
  <link rel="stylesheet" href="{{ url('styles/admin/css/vertical-layout-light/style.css') }}">
  <link rel="stylesheet" href="{{ url('styles/admin/css/vertical-layout-light/mystyle.css') }}">
  <link rel="stylesheet" href="{{ url('styles/admin/css/vertical-layout-light/wizard.css') }}">
  <link rel="stylesheet" href="{{ url('styles/admin/css/vertical-layout-light/notification.css') }}">
  <!-- endinject -->
