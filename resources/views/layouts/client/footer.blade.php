...
<script src="{{ asset('resources/styles/client/assets/js/modernizr-2.6.2.min.js') }}"></script>

<script src="{{ asset('resources/styles/client/assets/js/jquery-1.10.2.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/assets/js/bootstrap-select.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/assets/js/bootstrap-hover-dropdown.js') }}"></script>

<script src="{{ asset('resources/styles/client/assets/js/easypiechart.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/assets/js/jquery.easypiechart.min.js') }}"></script>

<script src="{{ asset('resources/styles/client/assets/js/owl.carousel.min.js') }}"></script>        

<script src="{{ asset('resources/styles/client/assets/js/wow.js') }}"></script>

<script src="{{ asset('resources/styles/client/assets/js/icheck.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/assets/js/price-range.js') }}"></script>


<script src="{{ asset('resources/styles/client/assets/js/jquery.ba-cond.min.js') }}"></script>
<script src="{{ asset('resources/styles/client/assets/js/jquery.slitslider.js') }}"></script>

<script src="{{ asset('resources/styles/client/assets/js/main.js') }}"></script>
